          ...
          >
            ...
            >
              ...
              {p.clinical_flags && p.clinical_flags.total > 0 && (
                <span
                  className="mr-2 inline-flex shrink-0 items-center gap-1 rounded-md border border-action-flag bg-action-flag/10 px-2 py-1 text-xs font-semibold text-action-flag"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span>
                      <Button
                        size="icon"
                        className="h-8 w-8 rounded-md border border-contact-email-border bg-contact-email text-contact-email-fg shadow-sm hover:bg-contact-email/85 hover:text-contact-email-fg"
